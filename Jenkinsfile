node {
	...
	checkout([$class: 'GitSCM', branches: [[name: 'leaf-brian-new-para']], doGenerateSubmoduleConfigurations: false, extensions: [[$class: 'RelativeTargetDirectory', relativeTargetDir: 'build_automation']], submoduleCfg: [], userRemoteConfigs: [[credentialsId: 'c07e71bc-f3f0-4d5a-9d43-a97236b89f1d', url: 'https://demo.ablevets.com/coderepo/scm/avss/build_automation.git']]])
    echo "ls -l"
	sh 'ls -l'
